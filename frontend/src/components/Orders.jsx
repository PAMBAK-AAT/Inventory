...
// import { useAuth } from '../context/AuthContext'; // Import this to check if user is admin
...
//     try {
//         const config = { headers: { Authorization: `Bearer ${localStorage.getItem("pos-token")}` } };
//         const res = await axios.delete(`http://localhost:3000/api/order/delete/${orderId}`, config);
        
//         if (res.data.success) {
//             // Remove the deleted order from the UI state immediately
...
//         </h1>
//         <p className="text-gray-500 mt-1">View and manage order history details</p>
//       </div>
...
//                         <div className="font-bold text-gray-800">{ord.customer?.name || "Unknown User"}</div>
//                         <div className="text-xs text-gray-500">{ord.customer?.email}</div>
//                     </td>

//                     <td className="px-6 py-4 font-bold text-gray-800">
//                         {ord.product?.name || "Product Deleted"}
//                     </td>
...
//                     <td className="px-6 py-4 text-gray-800 font-bold text-center">
//                         {ord.quantity}
//                     </td>
                    
//                     <td className="px-6 py-4 text-blue-600 font-black">
//                       {/* Using the saved totalPrice from DB, fallback to calc if old data */}
...
//                             className="p-2 text-red-500 bg-red-50 hover:bg-red-100 hover:text-red-700 rounded-lg transition-colors duration-200"
//                             title="Delete Order"
//                         >
//                             <Trash2 size={18} />
//                         </button>
